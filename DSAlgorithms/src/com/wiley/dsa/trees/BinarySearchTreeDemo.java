...
// write a BST implementation to hold Author object(id, name,No.ofBooksWritten)
// and perform all basic operation , traversing [preorder,postorder,inorder,levelorder]
// removal [3 cases]
